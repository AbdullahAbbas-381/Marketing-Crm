...
$info_right_column .= '<span style="font-weight:bold;font-size:27px; color: #5CC6C4">' . _l('invoice_pdf_heading') . '</span><br />';
$info_right_column .= '<b style="color:#5CC6C4;"># ' . $invoice_number . '</b>';
...
$organization_info = '<div style="color:#7fc5c3;">';
...
$tbltotal .= '
<tr style="background-color:#5CC6C4; color: #fff;">
...
if (get_option('show_amount_due_on_invoice') == 1 && $invoice->status != Invoices_model::STATUS_CANCELLED) {
    $tbltotal .= '<tr style="background-color:#7fc5c3; color: #fff;">
