...
$info_right_column .= '<span style="font-weight:bold;font-size:27px;color: #7fc5c3;">' . _l('estimate_pdf_heading') . '</span><br />';
$info_right_column .= '<b style="color:#7fc5c3;"># ' . $estimate_number . '</b>';
...
$tbltotal .= '
<tr style="background-color:#7fc5c3;color: #fff;">
