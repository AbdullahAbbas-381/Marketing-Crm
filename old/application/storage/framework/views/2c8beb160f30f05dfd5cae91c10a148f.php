        ...
        <div class="slimscrollright">
            ...
            <div class="r-panel-body table-config-ajax" data-url="<?php echo e(url('preferences/tables')); ?>" data-type="form"
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.parent_invoice'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.date'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.client_contact'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.created_by'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.project_id'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.project_title'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.tax'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.discount_type'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.discount_amount'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.last_payment'); ?>
                            - <?php echo app('translator')->get('lang.date'); ?>span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.last_payment'); ?>
                            - <?php echo app('translator')->get('lang.amount'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.last_payment'); ?>
                            - <?php echo app('translator')->get('lang.method'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.latest_payment'); ?>
                            - <?php echo app('translator')->get('lang.transaction_id'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.attachments'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.scheduled_publishing_date'); ?></span>
                    </label>
                </div>
                ...
                <div class="p-b-5">
                    ...
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.amount'); ?></span>
                    </label>
                </div>
                    ...
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.balance'); ?></span>
                    </label>
                </div>
            ...
            <div class="buttons-block">
                <button type="button" name="foo1" class="btn btn-rounded-x btn-secondary js-close-side-panels"
                    data-target="table-config-invoices"><?php echo e(cleanLang(__('lang.close'))); ?></button>
...
<!--sidebar--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/invoices/components/misc/table-config.blade.php ENDPATH**/ ?>