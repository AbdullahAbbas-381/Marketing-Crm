...
<form class="form">
    ...
    <!--importing settings-->
    <h5 class="p-t-20"><?php echo e(cleanLang(__('lang.importing_leads_settings'))); ?></h5>
    <div class="line"></div>

    <div class="modal-selector m-t-5 m-l-0 m-r-0">
        <h6 class="m-b-20"><?php echo app('translator')->get('lang.avoid_duplicates'); ?> <span class="align-middle text-info font-16" data-toggle="tooltip"
                title="<?php echo app('translator')->get('lang.avoid_duplicates_info'); ?>" data-placement="top"><i class="ti-info-alt"></i></span></h6>

        <!--settings2_importing_leads_duplicates_name-->
        <div class="form-group form-group-checkbox row">
            <label class="col-4 col-form-label text-left"><?php echo app('translator')->get('lang.name'); ?></label>
            <div class="col-8 text-left p-t-5">
                <input type="checkbox" id="settings2_importing_leads_duplicates_name"
                    ...
                    <?php echo e(runtimePrechecked($settings2->settings2_importing_leads_duplicates_name ?? '')); ?>>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-8 text-left p-t-5">
                <input type="checkbox" id="settings2_importing_leads_duplicates_email"
                    ...
                    <?php echo e(runtimePrechecked($settings2->settings2_importing_leads_duplicates_email ?? '')); ?>>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-8 text-left p-t-5">
                <input type="checkbox" id="settings2_importing_leads_duplicates_telephone"
                    ...
                    <?php echo e(runtimePrechecked($settings2->settings2_importing_leads_duplicates_telephone ?? '')); ?>>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-8 text-left p-t-5">
                <input type="checkbox" id="settings2_importing_leads_duplicates_company"
                    ...
                    <?php echo e(runtimePrechecked($settings2->settings2_importing_leads_duplicates_company ?? '')); ?>>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/settings/sections/leads/page.blade.php ENDPATH**/ ?>