    ...
    <div class="card">
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                ...
                <div class="align-self-center display-6 ml-auto"><p class="text-warning m-0 pound-symbol">£</p></div>
            </div>
        </div>
        <div class="progress">
...
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/home/admin/widgets/first-row/invoices-due.blade.php ENDPATH**/ ?>