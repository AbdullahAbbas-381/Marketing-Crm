...
<aside class="left-sidebar settings-menu">
    ...
    <div class="scroll-sidebar" id="settings-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="settings-sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php echo config('modules.menus.settings.parent1'); ?>
                ...
                <li class="sidenav-menu-item <?php echo e($page['settingsmenu_main'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php endif; ?>
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.general'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent2'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.billing'); ?>
                ...
                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent3'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.email'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent4'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.clients'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent5'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.projects'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent6'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.tasks'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent7'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.leads'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent8'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.milestones'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent9'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.invoices'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent10'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.estimates'); ?>
                ...
                <li class="sidenav-menu-item">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('lang.timesheets'); ?>
                        </span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li>
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.timesheets'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent11'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.proposals'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent12'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.contracts'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent13'); ?>
                ...
                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent14'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.expenses'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent15'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.subscriptions'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent16'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.tax'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent17'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.tags'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent18'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.files'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent19'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.payment_methods'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent20'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.roles'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent21'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.tickets'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent22'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.knowledgebase'); ?>
                ...
                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent23'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse" id="settings-menu-other">
                        ...
                        <li><a href="javascript:void(0);" data-url="/settings/system/info"
                                ...
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo app('translator')->get('lang.system_information'); ?></a>
                        </li>
                        <?php endif; ?>
                        <!--reCaptcha-->
                        ...
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.other'); ?>

                    </ul>
                </li>

                <!--[MODULES] - dynamic menu-->
                <?php echo config('modules.menus.settings.parent24'); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>