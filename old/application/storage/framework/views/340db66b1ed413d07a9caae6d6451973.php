...
<!--each row-->
<tr id="estimate_<?php echo e($estimate->bill_estimateid); ?>" class="<?php echo e($estimate->pinned_status ?? ''); ?>">
    ...
    <td class="estimates_col_created_by" id="estimates_col_created_by_<?php echo e($estimate->bill_estimateid); ?>">
        ...
        <span class="hidden printing_visible">
            <?php echo e($estimate->first_name ?? runtimeUnkownUser()); ?> <?php echo e($estimate->last_name ?? ''); ?>
    ...
    <td class="estimates_col_category">
        <?php echo e(str_limit($estimate->category_name ?? '---', 20)); ?></a>
    </td>
    ...
    <td class="estimates_col_action actions_column" id="estimates_col_action_<?php echo e($estimate->bill_estimateid); ?>">
        ...
        <span class="list-table-action">
            <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                data-parent="estimate_<?php echo e($estimate->bill_estimateid); ?>"
                data-url="<?php echo e(url('/estimates/'.$estimate->bill_estimateid.'/pinning')); ?>"
...
<!--each row--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/estimates/components/table/ajax.blade.php ENDPATH**/ ?>