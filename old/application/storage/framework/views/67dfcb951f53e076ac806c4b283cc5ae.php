                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[replies]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30" for="standard_field[replies]"><?php echo app('translator')->get('lang.replies'); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--sidebar--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/export/tickets/export.blade.php ENDPATH**/ ?>