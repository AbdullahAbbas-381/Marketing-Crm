<div class="card-group table-stats-cards  <?php echo e(runtimePreferenceStatsPanelPosition(auth()->user()->stats_panel_position)); ?>"
    id="list-pages-stats-widget">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar <?php echo e($stats[0]['color'] ?? ''); ?> h-px-4 w-100"
                            id="stats-widget-percentage-1" role="progressbar" aria-valuenow="25" aria-valuemin="0"
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar <?php echo e($stats[1]['color'] ?? ''); ?> h-px-4  w-100"
                            id="stats-widget-percentage-2" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                            aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar <?php echo e($stats[2]['color'] ?? ''); ?> h-px-4  w-100"
                            id="stats-widget-percentage-3" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                            aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
    ...
    <!-- Column -->
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/misc/list-pages-stats-3.blade.php ENDPATH**/ ?>