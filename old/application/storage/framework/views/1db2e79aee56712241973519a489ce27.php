...
<!--each row-->
<tr id="proposal_<?php echo e($proposal->doc_id); ?>" class="<?php echo e($proposal->pinned_status ?? ''); ?>">
        ...
        <span class="list-table-action font-size-inherit">
            ...
            <span class="list-table-action">
                <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                    data-parent="proposal_<?php echo e($proposal->doc_id); ?>"
                    data-url="<?php echo e(url('/proposals/'.$proposal->doc_id.'/pinning')); ?>"
...
<!--each row--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/proposals/components/table/ajax.blade.php ENDPATH**/ ?>