    ...
    <div id="list-page-actions">
                    ...
                    <div class="form-group row m-b-10">
                        <div class="col-sm-12">
                            ...
                            <input class="mysql-date" type="hidden" name="publishing_option_date"
                                id="publishing_option_date" value="<?php echo e($document->doc_publishing_scheduled_date	 ?? ''); ?>">
                        </div>
                    </div>
                </div>
                <!--form buttons-->
        ...
        <span class="dropdown">
            <button type="button" class="data-toggle-tooltip list-actions-button btn btn-page-actions waves-effect waves-dark 
                ...
                title="<?php echo e(cleanLang(__('lang.clone_proposal'))); ?>" data-toggle="modal" data-target="#commonModal"
                data-modal-title="<?php echo e(cleanLang(__('lang.clone_proposal'))); ?>"
                data-url="<?php echo e(url('/proposals/'.$document->doc_id.'/clone')); ?>"
                data-action-url="<?php echo e(url('/proposals/'.$document->doc_id.'/clone')); ?>"
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item confirm-action-danger <?php echo e(runtimeVisibility('document-status', 'revised', $document->doc_status)); ?>"
                    ...
                    <i class="ti-reload display-inline-block p-r-5"></i> <?php echo app('translator')->get('lang.mark_as_revised'); ?></a>
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_proposal'))); ?>"
            ...
            data-url="<?php echo e(url('/proposals/'.$document->doc_id.'?source=page')); ?>"><i class="sl-icon-trash"></i></button>
        <?php endif; ?>
    </div>
</div>
<!-- action buttons --><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/documents/components/proposal/actions-team.blade.php ENDPATH**/ ?>