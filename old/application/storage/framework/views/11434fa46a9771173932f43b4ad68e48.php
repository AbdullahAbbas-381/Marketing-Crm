<div class="card" id="comments-wrapper">
    ...
    <div class="comments card-body" id="js-trigger-comments" data-payload="<?php echo e($unique_comment_id); ?>">
        ...
        <!--star/unstar buttons-->
        <?php if(request('commentresource_type') == 'project' && request('commentresource_id') && isset($project) &&
        request('source') != 'starred'): ?>
        <div class="text-right m-b-20">
            <!--star button-->
            <button type="button"
                class="btn btn-sm btn-outline-default ajax-request <?php echo e($project->is_comment_starred ? 'hidden' : ''); ?>"
                id="starred-star-button"
                data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=project-comments&resource_id='.$project->project_id)); ?>"
                data-loading-target="starred-star-button" data-ajax-type="POST" data-on-start-submit-button="disable">
                <i class="ti-star"></i> <?php echo app('translator')->get('lang.star_project_comments'); ?>
            </button>

            <!--unstar button-->
            <button type="button"
                class="btn btn-sm btn-warning ajax-request <?php echo e(!$project->is_comment_starred ? 'hidden' : ''); ?>"
                id="starred-unstar-button"
                data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=project-comments&resource_id='.$project->project_id)); ?>"
                data-loading-target="starred-unstar-button" data-ajax-type="POST" data-on-start-submit-button="disable">
                <i class="ti-star"></i> <?php echo app('translator')->get('lang.unstar_project_comments'); ?>
            </button>
        </div>
        <?php endif; ?>
        ...
        <div class="post-comment display-flex flex-row" id="form-<?php echo e($unique_comment_id); ?>">
            ...
            <div class="form-group row x-message-field x-message-field-placeholder js-toggle-placeholder-element"
                ...
                <textarea class="form-control form-control-sm w-100"
                    rows="1"><?php echo e(cleanLang(__('lang.post_a_comment'))); ?>...</textarea>
            </div>
            <!--rich text editor-->
            <div class="form-group row x-message-field hidden" id="editor-container-<?php echo e($unique_comment_id); ?>">
                ...
                <textarea class="form-control form-control-sm w-100 tinymce-textarea" rows="2"
                    id="editor-<?php echo e($unique_comment_id); ?>" name="comment_text" id="comment_text"></textarea>
                <!--close button-->
                ...
                <input type="hidden" name="placeholder-container"
                    value="placeholder-container-<?php echo e($unique_comment_id); ?>">
...
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/comments/wrapper.blade.php ENDPATH**/ ?>