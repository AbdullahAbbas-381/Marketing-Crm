        ...
        <div>
            ...
            <div class="m-b-15"><img src="<?php echo e(getUsersAvatar($owner->avatar_directory, $owner->avatar_filename)); ?>"
                ...
                <a href="javascript:void(0);" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    data-toggle="modal" data-target="#commonModal" data-url="<?php echo e(url('contacts/'.$owner->id)); ?>"
                    ...
                    data-action-ajax-loading-target="commonModalBody"><?php echo e($owner->first_name); ?> <?php echo e($owner->last_name); ?>
...
<!-- Column --><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/client/components/misc/leftpanel.blade.php ENDPATH**/ ?>