...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <!--star button-->
        <button type="button"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark ajax-request <?php echo e($project->is_starred ? 'hidden' : ''); ?>"
            ...
            title="<?php echo e(cleanLang(__('lang.star_project'))); ?>">
            <i class="sl-icon-star"></i>
        </button>

        <!--unstar button-->
        <button type="button"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark ajax-request active <?php echo e(!$project->is_starred ? 'hidden' : ''); ?>"
            ...
            data-on-start-submit-button="disable" data-toggle="tooltip"
            title="<?php echo e(cleanLang(__('lang.unstar_project'))); ?>">
            <i class="sl-icon-star"></i>
        </button>
...
<!-- action buttons --><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>