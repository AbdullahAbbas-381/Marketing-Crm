    ...
    <div class="col-lg-12">
        ...
        <div class="hidden" id="edit_project_setings">
            ...
            <div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
                ...
                <div class="form-group form-group-checkbox row">
                    <label
                        class="col-5 col-form-label text-left required"><?php echo e(cleanLang(__('lang.project_checklist'))); ?></label>
                    <div class="col-7 text-left p-t-5">
                        <input type="checkbox" id="clientperm_checklists" name="clientperm_checklists"
                            class="filled-in chk-col-light-blue"
                            <?php echo e(runtimePrechecked($project['clientperm_checklists'] ?? '')); ?>>
        ...
        <?php endif; ?>
    </div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>