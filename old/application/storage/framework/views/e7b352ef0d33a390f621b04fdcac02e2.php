...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9 <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <?php if(auth()->user()->role->role_invoices > 1 && $bill->bill_status == 'overdue'): ?>
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.send_overdue_reminder'))); ?>"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark confirm-action-info p-t-0"
            href="javascript:void(0)" data-confirm-title="<?php echo e(cleanLang(__('lang.send_overdue_reminder_info'))); ?>"
            data-confirm-text="<?php echo e(cleanLang(__('lang.confirm'))); ?>"
            data-url="<?php echo e(urlResource('/invoices/'.$bill->bill_invoiceid.'/overdue-reminder')); ?>"
            id="invoice-action-email-invoice"><i class="mdi mdi-email-alert display-inline-block m-t--4 font-32"></i></button>
        <?php endif; ?>
...
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/bill/components/misc/invoice/actions.blade.php ENDPATH**/ ?>