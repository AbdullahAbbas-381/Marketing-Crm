...
<form>
    ...
    <div class="form-group row">
        <label class="col-4 col-form-label text-left required"><?php echo e(cleanLang(__('lang.project_check_lists'))); ?></label>
        <div class="col-4 text-left p-t-5">
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings_projects_clientperm_checklists"
                name="settings_projects_clientperm_checklists" data-preselected="<?php echo e($settings->settings_projects_clientperm_checklists ?? 'none'); ?>">
                <option></option>
                ...
                <option value="participate"><?php echo app('translator')->get('lang.participate'); ?></option>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/settings/sections/projects/client-permissions.blade.php ENDPATH**/ ?>