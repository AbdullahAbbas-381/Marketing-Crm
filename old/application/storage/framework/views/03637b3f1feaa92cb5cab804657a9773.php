...
<tr id="contact_<?php echo e($contact->id); ?>">
    ...
    <td class="contacts_col_first_name" id="contacts_col_first_name_<?php echo e($contact->id); ?>">
        ...
        <a href="javascript:void(0);"
            class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form user_profile_name_<?php echo e($contact->id); ?>"
            data-toggle="modal" data-target="#commonModal" data-url="<?php echo e(url('contacts/'.$contact->id)); ?>"
            ...
            data-action-ajax-loading-target="commonModalBody"><?php echo e($contact->first_name); ?> <?php echo e($contact->last_name); ?>

        </a>
        <?php else: ?>
        <span><?php echo e($contact->first_name); ?> <?php echo e($contact->last_name); ?></span>
        <?php endif; ?>
        <!--account owner-->
...
<!--each row--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>