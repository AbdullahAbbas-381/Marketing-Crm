...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.my_projects'))); ?>"
            ...
            data-url="<?php echo e(url('/projects/search?action=search&toggle=pref_filter_own_projects&filter_category='.request('filter_category').'&projectresource_type='.request('projectresource_type').'&projectresource_id='.request('projectresource_id'))); ?>">
        ...
        <!--PRINT-->
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.print'))); ?>" id="projects-print-button"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark js-print-table <?php echo e(config('visibility.print_button')); ?>"
...
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/projects/components/misc/list-page-actions.blade.php ENDPATH**/ ?>