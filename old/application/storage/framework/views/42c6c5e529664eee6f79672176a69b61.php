...
<form>
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label text-left"><?php echo e(cleanLang(__('lang.manage_project_checklist'))); ?></label>
        <div class="col-8 text-left p-t-5">
            <input type="checkbox" id="settings_projects_assignedperm_manage_checklists"
                ...
                <?php echo e(runtimePrechecked($settings['settings_projects_assignedperm_manage_checklists'] ?? '')); ?>>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/settings/sections/projects/staff-permissions.blade.php ENDPATH**/ ?>