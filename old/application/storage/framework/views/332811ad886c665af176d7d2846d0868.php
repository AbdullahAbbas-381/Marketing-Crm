<head>
    ...
    <link rel="stylesheet" href="/public/vendor/fonts/phosphor-icons/regular/style.css?v=<?php echo e(config('system.versioning')); ?>">

    
    
    <!--DYNAMIC CSS VARS-->
    <?php echo $__env->make('layout.dynamic-css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <link rel="stylesheet" href="/public/js/codemirror/codemirror.min.css?v=<?php echo e(config('system.versioning')); ?>">
    <link rel="stylesheet" href="/public/js/codemirror/darcula.min.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--[modules] css includes-->
    <?php echo config('css.modules'); ?>
...
</head><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/old/application/resources/views/layout/header.blade.php ENDPATH**/ ?>