        ...
        <div class="billing-mode-only-item">
            ...
            <span class="pull-right text-align-right">
                ...
                <!--reminder sent-->
                <?php if((auth()->check() && auth()->user()->is_team) && $bill->bill_status == 'overdue'): ?>
                <span>
                    <span
                        class="label label label-light-danger text-lc font-normal"><?php echo app('translator')->get('lang.overdue_reminders_sent'); ?> - 
                        <span id="invoice_overdue_reminder_counter"><?php echo e($bill->bill_overdue_reminder_counter ?? 0); ?></span></span>
                </span>
                <?php endif; ?>
            </span>
        </div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/bill/components/elements/invoice/header-web.blade.php ENDPATH**/ ?>