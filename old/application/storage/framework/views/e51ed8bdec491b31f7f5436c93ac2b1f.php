...
<ul class="nav nav-tabs profile-tab" role="tablist">
    ...
    <?php echo config('modules.menus.tabs.client.parent1'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent2'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent3'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent4'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent5'); ?>
    ...
    <li class="nav-item dropdown <?php echo e($page['tabmenu_files'] ?? ''); ?>">
        ...
        <div class="dropdown-menu" x-placement="bottom-start" id="fx-client-misc-topnave-files">
            ...
            <!--[MODULES] - dynamic menu-->
            <?php echo config('modules.menus.tabs.client.files'); ?>

        </div>
    </li>
    
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent6'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent7'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent8'); ?>
    ...
    <li class="nav-item dropdown <?php echo e($page['tabmenu_financial'] ?? ''); ?>">
        ...
        <div class="dropdown-menu" x-placement="bottom-start" id="fx-client-misc-topnave-billing">
            ...
            <!--[MODULES] - dynamic menu-->
            <?php echo config('modules.menus.tabs.client.financial'); ?>

        </div>
    </li>
    
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent9'); ?>
    ...
    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent10'); ?>

</ul><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/client/components/misc/topnav.blade.php ENDPATH**/ ?>