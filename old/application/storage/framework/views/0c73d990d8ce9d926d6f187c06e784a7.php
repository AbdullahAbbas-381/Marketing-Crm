...
<tr id="client_<?php echo e($client->client_id); ?>" class="<?php echo e($client->pinned_status ?? ''); ?>">
    ...
    <td class="clients_col_action actions_column" id="clients_col_action_<?php echo e($client->client_id); ?>">
        ...
        <span class="list-table-action">
            <a href="javascript:void(0);" title="<?php echo app('translator')->get('lang.log_in'); ?>" data-parent="client_<?php echo e($client->client_id); ?>"
        ...
        <!--star button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.star_client'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm opacity-4 ajax-request <?php echo e($client->is_starred ? 'hidden' : ''); ?>"
                id="starred-star-button-<?php echo e($client->client_id); ?>"
                data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=client&resource_id='.$client->client_id)); ?>"
                data-loading-target="starred-star-button-<?php echo e($client->client_id); ?>" data-ajax-type="POST"
        ...
        <!--unstar button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.unstar_client'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning <?php echo e(!$client->is_starred ? 'hidden' : ''); ?>"
                id="starred-unstar-button-<?php echo e($client->client_id); ?>"
                data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=client&resource_id='.$client->client_id)); ?>"
                data-loading-target="starred-unstar-button-<?php echo e($client->client_id); ?>" data-ajax-type="POST"
                data-on-start-submit-button="disable">
                <i class="sl-icon-star"></i>
            </button>
        </span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>