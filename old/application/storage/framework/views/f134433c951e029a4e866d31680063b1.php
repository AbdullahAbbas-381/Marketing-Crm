...
<form class="form" id="settingsFormCurrency">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-3 col-form-label"><?php echo app('translator')->get('lang.hide_decimal_points'); ?></label>
        <div class="col-9 p-t-5">
            <input type="checkbox" id="settings_system_currency_hide_decimal" name="settings_system_currency_hide_decimal"
                class="filled-in chk-col-light-blue"
                <?php echo e(runtimePrechecked($settings->settings_system_currency_hide_decimal ?? '')); ?>>
            <label for="settings_system_currency_hide_decimal"></label>
        </div>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/settings/sections/currency/page.blade.php ENDPATH**/ ?>