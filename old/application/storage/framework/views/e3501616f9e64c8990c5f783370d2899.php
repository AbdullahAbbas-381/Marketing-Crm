<div class="col-12 align-self-center hidden checkbox-actions  box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            ...
            data-url="<?php echo e(url('/invoices/delete')); ?>"
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="invoices-list-table"
            data-url="<?php echo e(url('/invoices/bulk-dettach-project')); ?>"
            data-confirm-title="<?php echo e(cleanLang(__('lang.detach_from_project'))); ?>"
            data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" id="checkbox-actions-dettach-project">
            <i class="sl-icon-link"></i> <?php echo e(cleanLang(__('lang.detach_from_project'))); ?></button>

        <!--email to client-->
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="invoices-list-table"
            data-url="<?php echo e(url('/invoices/bulk-email-client')); ?>"
            data-confirm-title="<?php echo e(cleanLang(__('lang.email_to_client'))); ?>"
            data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" id="checkbox-actions-email-invoices">
    ...
    <?php endif; ?>
</div><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/invoices/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>