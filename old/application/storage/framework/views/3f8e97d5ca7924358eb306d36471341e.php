            ...
            <div class="rpanel-title">
                ...
                <div class="x-top-nav">
                    <a class="right-sidepanel-menu right-sidepanel-reminders-menu ajax-request" href="javascript:void(0);"
                        id="right-sidepanel-reminders-menu-due" data-url="<?php echo e(url('reminders/topnav-feed?status=due')); ?>"
                        data-loading-target="sidepanel-reminders-container" data-target="sidepanel-reminders-container"
                        data-progress-bar='hidden'><?php echo app('translator')->get('lang.due_reminders'); ?></a>
                    ...
                    <a class="right-sidepanel-menu right-sidepanel-reminders-menu ajax-request" href="javascript:void(0);" id="right-sidepanel-reminders-menu-active"
                        data-url="<?php echo e(url('reminders/topnav-feed?status=active')); ?>"
                        data-loading-target="sidepanel-reminders-container" data-target="sidepanel-reminders-container"
                        data-progress-bar='hidden'><?php echo app('translator')->get('lang.pending_reminders'); ?></a>
                </div>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/nav/reminders-panel.blade.php ENDPATH**/ ?>