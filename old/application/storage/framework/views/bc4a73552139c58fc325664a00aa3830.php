...
<tr id="project_<?php echo e($project->project_id); ?>" class="<?php echo e($project->pinned_status ?? ''); ?>">
    ...
    <td class="projects_col_progress p-r-20 <?php echo e(config('table.tableconfig_column_7')); ?> tableconfig_column_7">
        ...
        <!--print view-->
        <div class="printing_progress_bar hidden"><?php echo e(round($project->project_progress)); ?>%</div>
    </td>
    ...
    <td
        class="projects_col_team column_assigned_users <?php echo e(config('table.tableconfig_column_21')); ?> tableconfig_column_21">
        <!--assigned users-->
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <div class="dropdown-menu" aria-labelledby="quick-access-button">
                ...
                <a class="dropdown-item js-toggle-side-panel js-quick-access-button" href="javascript:void(0)"
                    data-title="<?php echo app('translator')->get('lang.project_files'); ?>" data-target="quick-access-sidepanel"
                    data-url="<?php echo e(url('/projects/'.$project->project_id.'/quick-access/files')); ?>"
                    data-loading-target="commonModalBody"
                    data-action-ajax-loading-target="invoices-td-container"><?php echo app('translator')->get('lang.files'); ?></a>
            </div>
        ...
        <span class="list-table-action">
            <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                data-parent="project_<?php echo e($project->project_id); ?>"
                data-url="<?php echo e(url('/projects/'.$project->project_id.'/pinning')); ?>"
        ...
        <!--star button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.star_project'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle opacity-4 btn-sm ajax-request <?php echo e($project->is_starred ? 'hidden' : ''); ?>"
                id="starred-star-button-<?php echo e($project->project_id); ?>"
                data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=project&resource_id='.$project->project_id)); ?>"
                data-loading-target="starred-star-button-<?php echo e($project->project_id); ?>" data-ajax-type="POST"
        ...
        <!--unstar button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.unstar_project'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning <?php echo e(!$project->is_starred ? 'hidden' : ''); ?>"
                id="starred-unstar-button-<?php echo e($project->project_id); ?>"
                data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=project&resource_id='.$project->project_id)); ?>"
                data-loading-target="starred-unstar-button-<?php echo e($project->project_id); ?>" data-ajax-type="POST"
                data-on-start-submit-button="disable">
                <i class="sl-icon-star"></i>
            </button>
        </span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/u248167739/domains/accounts.paramountbuilt.co.uk/public_html/application/resources/views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>